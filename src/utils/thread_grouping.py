...
def group_messages_into_threads(messages: List[Union[Message, Dict[str, Any]]]) -> List[MessageThread]:
...
def find_thread_for_message(message: Union[Message, Dict[str, Any]], threads: List[MessageThread]) -> Optional[MessageThread]:
...
def find_thread_by_references(message: Union[Message, Dict[str, Any]], threads: List[MessageThread]) -> Optional[MessageThread]:
